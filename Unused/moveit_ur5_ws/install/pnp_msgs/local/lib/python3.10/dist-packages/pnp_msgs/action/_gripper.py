...
class Gripper_Goal(metaclass=Metaclass_Gripper_Goal):
    ...
    def __init__(self, **kwargs):
        ...
        self.gripper_goal = kwargs.get('gripper_goal', str())
    ...
    def gripper_goal(self, value):
        if __debug__:
            assert \
                ...
                "The 'gripper_goal' field must be of type 'str'"
...
class Gripper_Result(metaclass=Metaclass_Gripper_Result):
    ...
    def __init__(self, **kwargs):
        assert all('_' + key in self.__slots__ for key in kwargs.keys()), \
            'Invalid arguments passed to constructor: %s' % \
            ', '.join(sorted(k for k in kwargs.keys() if '_' + k not in self.__slots__))
        self.gripper_result = kwargs.get('gripper_result', str())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.gripper_result != other.gripper_result:
            return False
        return True
    ...
    @builtins.property
    def gripper_result(self):
        """Message field 'gripper_result'."""
        return self._gripper_result

    @gripper_result.setter
    def gripper_result(self, value):
        if __debug__:
            assert \
                isinstance(value, str), \
                "The 'gripper_result' field must be of type 'str'"
        self._gripper_result = value
    ...
    def gripper_progress(self, value):
        if __debug__:
            ...
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'gripper_progress' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
