...
class PickAndPlace_Goal(metaclass=Metaclass_PickAndPlace_Goal):
    ...
    _fields_and_field_types = {
        'pick_goal': 'geometry_msgs/Pose',
        'place_goal': 'geometry_msgs/Pose',
    }
    ...
    def __init__(self, **kwargs):
        ...
        from geometry_msgs.msg import Pose
        self.pick_goal = kwargs.get('pick_goal', Pose())
        from geometry_msgs.msg import Pose
        self.place_goal = kwargs.get('place_goal', Pose())
    ...
    def __eq__(self, other):
        ...
        if self.pick_goal != other.pick_goal:
            return False
        if self.place_goal != other.place_goal:
            return False
        return True
    ...
    def pick_goal(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'pick_goal' field must be a sub message of type 'Pose'"
        self._pick_goal = value

    @builtins.property
    def place_goal(self):
        """Message field 'place_goal'."""
        return self._place_goal

    @place_goal.setter
    def place_goal(self, value):
        if __debug__:
            from geometry_msgs.msg import Pose
            assert \
                isinstance(value, Pose), \
                "The 'place_goal' field must be a sub message of type 'Pose'"
        self._place_goal = value
...
class PickAndPlace_Result(metaclass=Metaclass_PickAndPlace_Result):
    ...
    def __init__(self, **kwargs):
        assert all('_' + key in self.__slots__ for key in kwargs.keys()), \
            'Invalid arguments passed to constructor: %s' % \
            ', '.join(sorted(k for k in kwargs.keys() if '_' + k not in self.__slots__))
        self.pnp_result = kwargs.get('pnp_result', str())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.pnp_result != other.pnp_result:
            return False
        return True
    ...
    @builtins.property
    def pnp_result(self):
        """Message field 'pnp_result'."""
        return self._pnp_result

    @pnp_result.setter
    def pnp_result(self, value):
        if __debug__:
            assert \
                isinstance(value, str), \
                "The 'pnp_result' field must be of type 'str'"
        self._pnp_result = value
...
class PickAndPlace_Feedback(metaclass=Metaclass_PickAndPlace_Feedback):
    ...
    def __init__(self, **kwargs):
        assert all('_' + key in self.__slots__ for key in kwargs.keys()), \
            'Invalid arguments passed to constructor: %s' % \
            ', '.join(sorted(k for k in kwargs.keys() if '_' + k not in self.__slots__))
        self.pnp_message = kwargs.get('pnp_message', str())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.pnp_message != other.pnp_message:
            return False
        return True
    ...
    @builtins.property
    def pnp_message(self):
        """Message field 'pnp_message'."""
        return self._pnp_message

    @pnp_message.setter
    def pnp_message(self, value):
        if __debug__:
            assert \
                isinstance(value, str), \
                "The 'pnp_message' field must be of type 'str'"
        self._pnp_message = value
