...
#include "geometry_msgs/msg/detail/pose__functions.h"  // pick_goal, place_goal
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: pick_goal
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->pick_goal, cdr))
    {
      return false;
    }
  }

  // Field name: place_goal
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_geometry_msgs__msg__Pose(
    &(ros_message->pick_goal), current_alignment);
  // field.name place_goal

  current_alignment += get_serialized_size_geometry_msgs__msg__Pose(
    &(ros_message->place_goal), current_alignment);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pnp_msgs__action__PickAndPlace_Goal;
    is_plain =
      (
      offsetof(DataType, place_goal) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _PickAndPlace_Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pnp_msgs__action__PickAndPlace_Goal(
...
#include "rosidl_runtime_c/string.h"  // pnp_result
#include "rosidl_runtime_c/string_functions.h"  // pnp_result
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: pnp_result
  {
    const rosidl_runtime_c__String * str = &ros_message->pnp_result;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: pnp_result
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->pnp_result.data) {
      rosidl_runtime_c__String__init(&ros_message->pnp_result);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->pnp_result,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'pnp_result'\n");
      return false;
    }
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = pnp_msgs__action__PickAndPlace_Result;
    is_plain =
      (
      offsetof(DataType, pnp_result) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _PickAndPlace_Result__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pnp_msgs__action__PickAndPlace_Result(
    full_bounded, is_plain, 0);
...
// already included above
// #include "rosidl_runtime_c/string.h"  // pnp_message
// already included above
// #include "rosidl_runtime_c/string_functions.h"  // pnp_message
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: pnp_message
  {
    const rosidl_runtime_c__String * str = &ros_message->pnp_message;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: pnp_message
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->pnp_message.data) {
      rosidl_runtime_c__String__init(&ros_message->pnp_message);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->pnp_message,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'pnp_message'\n");
      return false;
    }
  }
  ...
  size_t current_alignment)
{
  ...
  current_alignment += padding +
    eprosima::fastcdr::Cdr::alignment(current_alignment, padding) +
    (ros_message->pnp_message.size + 1);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = pnp_msgs__action__PickAndPlace_Feedback;
    is_plain =
      (
      offsetof(DataType, pnp_message) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _PickAndPlace_Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pnp_msgs__action__PickAndPlace_Feedback(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = pnp_msgs__action__PickAndPlace_SendGoal_Request;
    is_plain =
      (
...
static size_t _PickAndPlace_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pnp_msgs__action__PickAndPlace_SendGoal_Request(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = pnp_msgs__action__PickAndPlace_SendGoal_Response;
    is_plain =
      (
...
static size_t _PickAndPlace_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pnp_msgs__action__PickAndPlace_SendGoal_Response(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = pnp_msgs__action__PickAndPlace_GetResult_Request;
    is_plain =
      (
...
static size_t _PickAndPlace_GetResult_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pnp_msgs__action__PickAndPlace_GetResult_Request(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = pnp_msgs__action__PickAndPlace_GetResult_Response;
    is_plain =
      (
...
static size_t _PickAndPlace_GetResult_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pnp_msgs__action__PickAndPlace_GetResult_Response(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = pnp_msgs__action__PickAndPlace_FeedbackMessage;
    is_plain =
      (
...
static size_t _PickAndPlace_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pnp_msgs__action__PickAndPlace_FeedbackMessage(
    full_bounded, is_plain, 0);
