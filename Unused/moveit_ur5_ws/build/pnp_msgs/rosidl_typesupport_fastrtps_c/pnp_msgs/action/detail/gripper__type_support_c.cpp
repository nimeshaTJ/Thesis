...
#include "rosidl_runtime_c/string.h"  // gripper_goal
#include "rosidl_runtime_c/string_functions.h"  // gripper_goal
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    const rosidl_runtime_c__String * str = &ros_message->gripper_goal;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: gripper_goal
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->gripper_goal.data) {
      rosidl_runtime_c__String__init(&ros_message->gripper_goal);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->gripper_goal,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'gripper_goal'\n");
      return false;
    }
  }
  ...
  size_t current_alignment)
{
  ...
  current_alignment += padding +
    ...
    (ros_message->gripper_goal.size + 1);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pnp_msgs__action__Gripper_Goal;
    is_plain =
      (
...
static size_t _Gripper_Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pnp_msgs__action__Gripper_Goal(
...
// already included above
// #include "rosidl_runtime_c/string.h"  // gripper_result
// already included above
// #include "rosidl_runtime_c/string_functions.h"  // gripper_result
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: gripper_result
  {
    const rosidl_runtime_c__String * str = &ros_message->gripper_result;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: gripper_result
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->gripper_result.data) {
      rosidl_runtime_c__String__init(&ros_message->gripper_result);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->gripper_result,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'gripper_result'\n");
      return false;
    }
  }
  ...
  size_t current_alignment)
{
  ...
  current_alignment += padding +
    eprosima::fastcdr::Cdr::alignment(current_alignment, padding) +
    (ros_message->gripper_result.size + 1);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = pnp_msgs__action__Gripper_Result;
    is_plain =
      (
      offsetof(DataType, gripper_result) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _Gripper_Result__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pnp_msgs__action__Gripper_Result(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = pnp_msgs__action__Gripper_Feedback;
    is_plain =
      (
      offsetof(DataType, gripper_progress) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _Gripper_Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pnp_msgs__action__Gripper_Feedback(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = pnp_msgs__action__Gripper_SendGoal_Request;
    is_plain =
      (
...
static size_t _Gripper_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pnp_msgs__action__Gripper_SendGoal_Request(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = pnp_msgs__action__Gripper_SendGoal_Response;
    is_plain =
      (
...
static size_t _Gripper_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pnp_msgs__action__Gripper_SendGoal_Response(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = pnp_msgs__action__Gripper_GetResult_Request;
    is_plain =
      (
...
static size_t _Gripper_GetResult_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pnp_msgs__action__Gripper_GetResult_Request(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = pnp_msgs__action__Gripper_GetResult_Response;
    is_plain =
      (
...
static size_t _Gripper_GetResult_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pnp_msgs__action__Gripper_GetResult_Response(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = pnp_msgs__action__Gripper_FeedbackMessage;
    is_plain =
      (
...
static size_t _Gripper_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pnp_msgs__action__Gripper_FeedbackMessage(
    full_bounded, is_plain, 0);
