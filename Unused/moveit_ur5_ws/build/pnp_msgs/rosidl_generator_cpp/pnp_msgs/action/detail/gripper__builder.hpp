...
class Init_Gripper_Goal_gripper_goal
{
public:
  Init_Gripper_Goal_gripper_goal()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::pnp_msgs::action::Gripper_Goal gripper_goal(::pnp_msgs::action::Gripper_Goal::_gripper_goal_type arg)
  {
...
{
  return pnp_msgs::action::builder::Init_Gripper_Goal_gripper_goal();
}
...
class Init_Gripper_Result_gripper_result
{
public:
  Init_Gripper_Result_gripper_result()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::pnp_msgs::action::Gripper_Result gripper_result(::pnp_msgs::action::Gripper_Result::_gripper_result_type arg)
  {
    msg_.gripper_result = std::move(arg);
    return std::move(msg_);
  }
...
{
  return pnp_msgs::action::builder::Init_Gripper_Result_gripper_result();
}
